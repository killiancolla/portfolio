...
export default async function LocaleLayout(props: {
  ...
  const jsonLd = {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": locale === 'fr' ? "Création de site vitrine" : "Showcase Website", "url": `${siteUrl}/${locale}/creation-site-vitrine-nice` } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": locale === 'fr' ? "Développement SaaS" : "SaaS Development", "url": `${siteUrl}/${locale}/developpement-saas` } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": locale === 'fr' ? "Création de site e-commerce" : "E-commerce Website", "url": `${siteUrl}/${locale}/site-e-commerce-nice` } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": locale === 'fr' ? "Application web sur mesure" : "Custom Web Application", "url": `${siteUrl}/${locale}/application-web-sur-mesure` } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": locale === 'fr' ? "Refonte et optimisation de site web" : "Website Redesign & Optimization", "url": `${siteUrl}/${locale}/refonte-optimisation-site-web` } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": locale === 'fr' ? "Conseil et accompagnement digital" : "Digital Consulting & Advisory", "url": `${siteUrl}/${locale}/conseil-accompagnement-digital` } },
      ],
    },
    "founder": {
      "@type": "Person",
